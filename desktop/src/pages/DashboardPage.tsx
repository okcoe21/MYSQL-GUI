...
import { Database, Table, Home, Layout, FileText, Code, Trash2, Upload, Download, Clock, Wand2 } from "lucide-react";
import TableData from "./dashboard/TableData";
import SqlEditor from "./dashboard/SqlEditor";
import DbOverview from "./dashboard/DbOverview";
import StructureView from "./dashboard/StructureView";
import InsertView from "./dashboard/InsertView";
import OperationsView from "./dashboard/OperationsView";
import ServerOverview from "./dashboard/ServerOverview";
...
import VisualQueryBuilder from "./dashboard/VisualQueryBuilder";
import ObjectView from "./dashboard/ObjectView";
import UserManagement from "./dashboard/UserManagement";
import DiagramView from "./dashboard/DiagramView";
import PerformanceDashboard from "./dashboard/PerformanceDashboard";
import MockDataView from "./dashboard/MockDataView";
import SlowQueryLog from "./dashboard/SlowQueryLog";
